...
3. Decide whether the mean of a populationis different from a hypothesized value.
...
The **standard error (SE)** is the standard deviation of the **sampling distribution** of a statistic. The **sampleing distribution** of a statistic is the distribution of that statistic, considered as a random variable, when derived from a random sample of size _n_.
