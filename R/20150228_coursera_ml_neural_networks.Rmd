## Neural Networks
In the last exercise [Multi-class classification with logistic regression](http://mlbernauer.bitbucket.org/R/20150225_coursera_ml_multiclass_classification_logistic_regression.html) we implemented a mult-class classifier that was capable of recognizing handwritten digits. However,
...
non-linear hypotheses. In this exercise we will used parameters from a neural network that has already been trianed. The goal is to use a feedforward
